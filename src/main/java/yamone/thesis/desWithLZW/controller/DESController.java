...
public class DESController {
    ...
    public ResponseEntity<byte[]> encryptFile(@RequestParam("file") MultipartFile file, @RequestParam String key) throws IOException {
    ...
    public ResponseEntity<byte[]> decryptFile(@RequestParam("file") MultipartFile file, @RequestParam String key) throws IOException {
        byte[] fileBytes = file.getBytes();
        String s = Base64.getEncoder().encodeToString(fileBytes);
